...
class _$CarsImpl implements _Cars {
  _$CarsImpl(
      {required this.id, required this.availability, required this.price});
  ...
  @override
  String toString() {
    return 'Cars(id: $id, availability: $availability, price: $price)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, id, availability, price);
